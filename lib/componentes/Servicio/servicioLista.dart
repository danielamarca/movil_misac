...
class _ListaServicioState extends State<ListaServicio> {
  ...
  void didChangeDependencies() {
    ...
    _ServicioServicioProvider.localServicioDetalle();
  }
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Expanded(
            child: Consumer<ServicioServicioProvider>(
              builder: (context, servicioServicioProvider, child) {
                return ListView.builder(
                  itemCount: servicioServicioProvider.servicioDetalle.length,
                  itemBuilder: (context, index) {
                    Servicio servicioSimple = Servicio(
                        id: servicioServicioProvider.servicioDetalle[index].id,
                        descripcion: servicioServicioProvider
                            .servicioDetalle[index].descripcion,
                        estado: servicioServicioProvider
                            .servicioDetalle[index].estado);
                    Cliente? cliente = servicioServicioProvider
                        .servicioDetalle[index]?.id_cliente;
                    ServicioTipo? tipo = servicioServicioProvider
                        .servicioDetalle[index].id_servicio_tipo;
                    return Card(
                      child: InkWell(
                        onTap: () {
                            ...
                            ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text(servicioSimple?.descripcion ?? '')
                                  // Text(
                                  //   'Rol: ${empleado.rol}',
                                  // ),
  ...
  //             ],
  //           ),
  //           body: EmpleadoModificar(empleado, _ServicioServicioProvider),
  //         ),
  ...
  //       ),
  //     );
  //     _ServicioServicioProvider.syncEmpleado();
  //   } catch (e) {
  //     if (e is DioError &&
  //         e.response != null &&
  ...
  //   setState(() {
  //     if (query.isEmpty) {
  //       _ServicioServicioProvider.filtrarEmpleados(null);
  //     } else {
  //       _ServicioServicioProvider.filtrarEmpleados(query.toLowerCase());
  //     }
  //   });
  // }
}
